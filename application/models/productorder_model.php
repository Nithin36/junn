...
function check_productorder2($pid,$cid)
{                    

$sql="select productorder.*"

." from productorder  where cusid='".$cid."' and productid='".$pid."' and orderstatus=0" ;
...
public function get_productorder4($pid,$cid)
{  
$this->db->select('productorder.*');
//$this->db->from('productorder');
$this->db->where('productid', $pid);
...
function update_productorder3($data,$pid,$cid)
{
