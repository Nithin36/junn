...
<form id="login2">
<p><input name="email2" id="email2" placeholder="Email" type="text"></p>
<p><input name="password23" id="password23" placeholder="Password" type="password"></p>
<p><input name="login" class="login loginmodal-submit" value="Login" id="login2btn" type="submit"></p>
</form>
...
<!--    <li <?php if ($this->router->fetch_class() == "gallery") { ?> class="active" <?php } ?>> <?php echo anchor('gallery/photos', 'Gallery'); ?> </li>   -->
<!--                <li class="dropdown">
