...
--
-- Host: localhost:3306
-- Generation Time: Feb 27, 2018 at 10:14 AM
...
CREATE TABLE IF NOT EXISTS `homemenu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
(2, 'admin', 'admin', 'admin', '45abb9b6267cd7d91246b60b341eec44', 'Q29wYVgxMjM=', 'admin', 'admin', 1);
...
CREATE TABLE IF NOT EXISTS `sizename` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;
