...
Image Url
        ...
        <div class="form-group">
<label>Photo (should be 283*210 px ):</label>
 <input type="file" name="file[]" class="validate[required]"   id="image_file" >
     ...
     <div class="form-group">
                                            ...
                                            <select id="order" name="num" class="form-control validate[required]" >
                                                ...
                                                <?php
                                                $facility_model->order();
                                                ?>
                                            </select>
                                        </div>
    
<input id="formbutton" name="addfacilityphotos" type="submit" value="Submit" class="btn btn-primary"/>
