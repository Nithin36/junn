...
?>
	 ...
	 $pgno = intval($_GET["pgno"]);
			 ...
			 $pquery=" select * from project   order by status,num  ";
...
{
    ?>
                                                <img src="../upload/projects/download.png" height="50" width="50" alt=""/>
     <?php                                           
}
 else {
...
?>
                                                <img src="../upload/projects/<?php echo $row['photo']?>" height="50" width="50" alt=""/>
<?php
 }
?>
                                </td>
                                ...
                                <td><?php echo $row['status']; ?></td>
                                    ...
                                    <td><a href="edit_project.php?id=<?php echo $row['id'].$url; ?>" class="btn btn-default">Edit</a></td>
                                <td><a href="#" data-href="controller/project_controller.php?del_id=<?php echo $row['id'].$url; ?>" class="btn btn-danger" data-toggle="modal"  data-target="#confirm-delete">Delete</a></td>
                                        </tr>
  ...
  if($status=="yes")
      ...
      if($project_model->affectedselectedrows($pquery)>$perpage)
                                ...
                                {
                $pgurl="list_project.php?page=project";
			
			$table=" project   ";


			$subquery=" order by status,num  ";
