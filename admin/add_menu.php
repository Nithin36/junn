...
<input name="name" type="text" id="name" class="form-control" data-validation-engine="validate[required]" placeholder="Menu Name">
</div>
...
<input id="formbutton" name="addmenu" type="submit" value="Submit" class="btn btn-primary"/>
