...
<input name="name" type="text" id="name" class="form-control" data-validation-engine="validate[required]" placeholder="Sub Service Name">
</div>
...
?>
        ...
        <div class="form-group">
<label>Sub Service Icon (should be 550*165 px ):</label>
...
<input id="formbutton" name="addsubservice" type="submit" value="Submit" class="btn btn-primary"/>
