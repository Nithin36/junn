...
<div class="col-lg-6" style=" width: 100%;">
 <?php
                                    if(isset($_GET['id']))
                                    {
                                        $row=$news_model->get_news($_GET['id']);
                                        //$row=$news_model->stripslahes_rows($row);
                                    ?>
...
{
    ?>
    <img src="../upload/news/download.png" height="100" width="100" alt=""/>
     <?php                                           
}
 else {
...
?>
    <img src="../upload/news/<?php echo $row['image']?>" height="100" width="100" alt=""/>
<?php
 }
?>
</div>
...
<input name="name" type="text" id="name" class="form-control validate[required]" placeholder="News Name" value="<?php echo $row['name'];?>">
</div>
...
<label class="radio-inline">
    ...
    <div class="form-group">
                                            ...
                                            <select id="order" name="num" class="form-control validate[required]" >
                                                ...
                                                <?php
                                                $news_model->order_selected($row['num']);
                                                ?>
                                            </select>
                                        </div> 
     <div class="form-group">
<label> Sector Icon  (should be 358*253 px ):</label>
 <input type="file" name="file[]" class=""  id="img"/>
</div>
    
<input id="formbutton" name="editnews" type="submit" value="Submit" class="btn btn-primary"/>
