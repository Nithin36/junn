...
<input name="designation" type="text" id="name" class="form-control validate[required]"  placeholder="Designation">
</div>
<!--<div class="form-group">
...
<input id="formbutton" name="addmanagement" type="submit" value="Submit" class="btn btn-primary"/>
