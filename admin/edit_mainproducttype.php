...
<div class="col-lg-6" >
 <?php
                                    if(isset($_GET['id']))
                                    {
                                        $row=$mainproducttype_model->get_mainproducttype($_GET['id']);
                                        $row=$mainproducttype_model->stripslahes_rows($row);
                                    ?>
...
<input name="description" type="hidden" id="description" value="<?php  echo $row['description']; ?>" />
    ...
    <div class="form-group">
                                            ...
                                            <select id="order" name="num" class="form-control validate[required]" >
                                                ...
                                                <?php
                                                $mainproducttype_model->order_selected($row['num']);
                                                ?>
                                            </select>
                                        </div> 
     
    
<input id="formbutton" name="editmainproducttype" type="submit" value="Submit" class="btn btn-primary"/>
...
<?php
$mainproducttype_model->Lobibox2();
?>
CKEDITOR.replace( 'editor1', {
