...
<input name="name" type="text" id="name" class="form-control" data-validation-engine="validate[required]" placeholder="Service Name">
</div>
...
?>
        ...
        <div class="form-group">
<label>Service Icon (should be 273*160 px ):</label>
...
<input id="formbutton" name="addservice" type="submit" value="Submit" class="btn btn-primary"/>
