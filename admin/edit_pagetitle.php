...
<div class="col-lg-6" >
 <?php
                                    if(isset($_GET['id']))
                                    {
                                        $row=$pagetitle_model->get_pagetitle($_GET['id']);
...
<input id="formbutton" name="editpagetitle" type="submit" value="Submit" class="btn btn-primary"/>
