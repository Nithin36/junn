...
<!-- page header -->
<div class="col-lg-12">
<h1 class="page-header">Vechile</h1>
</div>
<!--end page header -->
</div>
<div class="row">
...
<label>Vechile</label>
<input name="name" type="text" id="name" class="form-control" data-validation-engine="validate[required]"  placeholder="Vechile">
   </div>
    <div class="form-group">
<label>No of items</label>
<input name="quantity" type="text" id="quantity" class="form-control" data-validation-engine="validate[required]"  placeholder="No of items">
   </div>
...
var dataString = 'viewvechile=viewvechile&id=<?php echo $_GET['id'];?>';
$.ajax({

type: "POST",
url: "controller/vechile_controller.php",
data: dataString,
...
error: function() 
{
 ...
 var name=$('input[name=name]').val() ;
      ...
      var dataString = 'editvechile=editvechile&quantity='+quantity+'&num='+num+'&name='+name+'&id=<?php echo $_GET['id'];?>';
      $.ajax({
