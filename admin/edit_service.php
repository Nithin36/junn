...
<div class="col-lg-6" style=" width: 100%;">
 <?php
                                    if(isset($_GET['id']))
                                    {
                                        $row=$service_model->get_service($_GET['id']);
                                        //$row=$service_model->stripslahes_rows($row);
                                    ?>
    <form role="form" id="form" action="controller/service_controller.php" method="post" enctype="multipart/form-data">
...
{
    ?>
    <img src="../upload/service/download.png" height="100" width="100" alt=""/>
     <?php                                           
}
 else {
...
?>
    <img src="../upload/service/<?php echo $row['image']?>" height="100" width="100" alt=""/>
<?php
 }
?>
</div>
...
<label class="radio-inline">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
<label> Sector Icon  (should be 273*160  px ):</label>
 <input type="file" name="file[]" class=""  id="img"/>
</div>
    
<input id="formbutton" name="editservice" type="submit" value="Submit" class="btn btn-primary"/>
