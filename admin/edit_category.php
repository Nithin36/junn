...
categorys-Edit category
</div>
<div class="panel-body">
<div id="status">
<?php

//$category_model->action2();
?>
...
if(isset($_GET['id']))
{
$row=$category_model->get_category($_GET['id']);
//$row=$category_model->stripslahes_rows($row);
?>
<form role="form" id="form" action="controller/category_controller.php" method="post" enctype="multipart/form-data">
...
<?php
$category_model->order_selected($row['num']);
?>
</select>
</div> -->
...
<input id="formbutton" name="editcategory" type="submit" value="Submit" class="btn btn-primary"/>
