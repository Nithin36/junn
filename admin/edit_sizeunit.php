...
Size Units-Edit Size unit
</div>
<div class="panel-body">
<div id="status">
    <?php
    
    $sizeunit_model->action2();
    ?>
...
<div class="col-lg-6"  >
 <?php
                                    if(isset($_GET['id']))
                                    {
                                        $row=$sizeunit_model->get_sizeunit($_GET['id']);
                                        $row=$sizeunit_model->stripslahes_rows($row);
                                    ?>
...
<input name="name" type="text" id="name" class="form-control validate[required]" placeholder="sizeunit" value="<?php echo $row['name'];?>">
</div>
...
<input id="formbutton" name="editsizeunit" type="submit" value="Submit" class="btn btn-primary"/>
