    ...
    <input type="hidden" name="id" value="<?php echo $row['id'] ?>"/>
             ...
             <div class="form-group">
                                            ...
                                            <select id="projecttype" name="projecttype" class="form-control" data-validation-engine="validate[required]"  >
                                                ...
                                                <?php
                                                $projecttype_model->selectbox_projecttype($row['projecttype']);
                                                ?>
                                            </select>
                                        </div>
...
<input name="name" type="text" id="name" class="form-control validate[required]" placeholder="project" value="<?php echo $row['name'];?>">
                  ...
                  <div class="form-group">
<label>Client:</label>
<input name="client" type="text" id="client" class="form-control " data-validation-engine="validate[required]" placeholder="Client" value="<?php echo $row['client'];?>">
</div> 
            <div class="form-group">
<label>Plant:</label>
<input name="plant" type="text" id="plant" class="form-control " value="<?php echo $row['plant'];?>" placeholder="Plant">
</div>
...
$(document).ready(function(){
 ...
 $("#form").validationEngine({
      ...
      var dataString = 'editproject=editproject&num='+num+'&name='+name+'&plant='+plant+'&status='+status+'&projecttype='+projecttype+'&client='+client+'&id=<?php echo $_GET['id'];?>';
...
if(json.status=="yes")
{
    $('#load').css('display','none');
     $('input[name=name]').val(json.name) ;
                ...
                $('input[name=plant]').val(json.plant) ;
               $('input[name=client]').val(json.client) ;
              
                $("#num option").filter(function() {
           if ( $(this).val() == json.nun ) {
               return true;
            }
         }).prop('selected', true);
