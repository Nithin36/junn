...
$pquery=" select  productorder.*,(select name from product where id=productorder.productid) as pname,(select photo from product where id=productorder.productid) as pphoto,(select id from product where id=productorder.productid) as pid,customer.fname as cname, customer.email as cemail,customer.mobno as cmobno from productorder"
. " left join customer on customer.id=productorder.cusid where productorder.orderstatus=1 order by productorder.id desc  ";
...
$table=" productorder  where orderstatus=1  ";
