...
<label>Client*:</label>
<input name="name" type="text" id="name" class="form-control validate[required]"  placeholder="Client">
</div>
<!--<div class="form-group">
...
<input id="formbutton" name="addclient" type="submit" value="Submit" class="btn btn-primary"/>
