...
//    require_once "model/mainproducttype_model.php";
...
<form role="form" id="form" action="controller/mainproducttype_controller.php" method="post" enctype="multipart/form-data">


<div class="form-group">
<label>Category *:</label>
<input name="name" type="text" id="name" class="form-control validate[required]"  placeholder="Category">
</div>
...
<?php
$projecttype_model->order();
?>
</select>
</div>

<input id="formbutton" name="addprojecttype" type="submit" id="formbutton" value="Submit" class="btn btn-primary" />
...
$(document).ready(function(){
 ...
 $("#form").validationEngine({
      ...
      var dataString = 'addprojecttype=addprojecttype&num='+num+'&name='+name+'';
