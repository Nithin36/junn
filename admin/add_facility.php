...
<input name="name" type="text" id="name" class="form-control" data-validation-engine="validate[required]" placeholder="Facility Name">
</div>
...
<input id="formbutton" name="addfacility" type="submit" value="Submit" class="btn btn-primary"/>
