...
<div class="col-lg-6" style=" width: 100%;">
 <?php
                                    if(isset($_GET['id']))
                                    {
                                        $row=$facility_model->get_facility($_GET['id']);
                                        //$row=$facility_model->stripslahes_rows($row);
                                    ?>
    <form role="form" id="form" action="controller/facility_controller.php" method="post" enctype="multipart/form-data">
...
<input name="name" type="text" id="name" class="form-control validate[required]" placeholder="facility" value="<?php echo $row['name'];?>">
</div>
...
<label class="radio-inline">
    ...
    <div class="form-group">
                                            ...
                                            <select id="order" name="num" class="form-control validate[required]" >
                                                ...
                                                <?php
                                                $facility_model->order_selected($row['num']);
                                                ?>
                                            </select>
                                        </div> 
     
    
<input id="formbutton" name="editfacility" type="submit" value="Submit" class="btn btn-primary"/>
