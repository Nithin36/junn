...
<input name="quantity" type="text" id="quantity" class="form-control" data-validation-engine="validate[required]"  placeholder="Name">
   </div>
 <div class="form-group">
<label>Model</label>
<input name="model" type="text" id="model" class="form-control" data-validation-engine="validate[required]"  placeholder="Model">
   </div>
...
var dataString = 'viewequipment=viewequipment&id=<?php echo $_GET['id'];?>';
$.ajax({

type: "POST",
url: "controller/equipment_controller.php",
data: dataString,
...
error: function() 
{
 ...
 var model=$('input[name=model]').val() ;
      ...
      var dataString = 'editequipment=editequipment&quantity='+quantity+'&model='+model+'&num='+num+'&name='+name+'&id=<?php echo $_GET['id'];?>';
      $.ajax({
