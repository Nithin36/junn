...
<label>Title*:</label>
<input name="name" type="text" id="name" class="form-control validate[required]"  placeholder="Title">
</div>
<!--<div class="form-group">
 ...
 <input type="file" name="file[]" class="validate[required]"   id="image_file" >
     ...
     <div class="form-group">
                                            ...
                                            <select id="order" name="num" class="form-control validate[required]" >
                                                ...
                                                <?php
                                                $download_model->order();
                                                ?>
                                            </select>
                                        </div>
    
<input id="formbutton" name="adddownload" type="submit" value="Submit" class="btn btn-primary"/>
